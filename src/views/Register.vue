  ...
  <form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <p>
        ...
        <span class="accept_rules" @click="showRulesModal">{{'Rules'|localize}}</span>
      </p>
    </div>
    <div class="card-action">
      <div>
        <button class="btn btn-dark waves-effect waves-light auth-submit btn-black-bcgr" type="submit">
          {{'Register'|localize}}
      ...
      <p class="center">
        {{'HasAccount'|localize}}
        <router-link to="/login" class="link-auth">{{'Login'|localize}}</router-link>
      </p>
    </div>
  </form>
</template>
